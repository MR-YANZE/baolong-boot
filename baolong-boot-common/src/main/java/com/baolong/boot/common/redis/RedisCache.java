 ...
 * Redis 缓存操作类
 * <p>
 * 注意：使用时需要把值序列化成 Json 对象之后在进行存储；
 *
 * @author Baolong 2024/6/6 21:50
 * @version 1.0
 * @since 1.8
 */
@Component
public class RedisCache {
	 ...
	 * @return HashOperations<String, Object, Object>【键操作对象】
	 */
	public HashOperations<String, Object, Object> opsHash(RedisTemplate<String, String> redisTemplate) {
		if (redisTemplate == null) {
